...
<div class="flex flex-col gap-1 w-full">
  ...
  <div class="relative">
    <input
      ...
      id={name}
      class="
        bg-[#ADCAD8BF] dark:bg-[#E3D2EF99] px-2 py-1 rounded-sm
        backdrop-blur-xs w-full text-sm border border-transparent
        focus:outline-none focus:border-blue-400 dark:focus:border-neutral-600
        focus:ring-4 focus:ring-blue-300/60 dark:focus:ring-neutral-600/20"
    >
    {#if rightIcon}
